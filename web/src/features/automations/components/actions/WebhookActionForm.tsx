  ...
  headers: z.array(
    z.object({
      name: z.string().refine(
        ...
        {
          message:
            "This header is automatically added by Active Trace and cannot be customized",
        },
      ),
      value: z.string(),
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="mb-4">
          <FormDescription className="mb-2">
            Default headers (automatically added by Active Trace):
          </FormDescription>
          {Object.entries({
            ...WebhookDefaultHeaders,
            "x-activetrace-signature": `t=<timestamp>,v1=<signature>`,
          }).map(([key, value]) => (
            <div
              key={key}
      ...
      <div>
        ...
        <FormDescription className="mb-2">
          ...
          is automatically included in the x-activetrace-signature header.
        </FormDescription>
